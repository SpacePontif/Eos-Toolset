...
namespace Eos.Views
{
    public partial class ItemPropertyTableView : LanguageAwarePage
    {
        private ItemPropertyTableViewModel? oldViewModel = null;

        public ItemPropertyTableView()
        {
            InitializeComponent();
        ...
        {
            if (oldViewModel is ItemPropertyTableViewModel oldVM)
            {
            ...
            oldViewModel = null;
            if (DataContext is ItemPropertyTableViewModel newVM)
            {
        ...
        {
            if (DataContext is ItemPropertyTableViewModel vm)
            {
        ...
        private void UpdateContentPresenters(ItemPropertyTableItem? item, DataGridRow? row = null)
        {
        ...
        {
            if (grItems.ItemsSource is Repository<ItemPropertyTableItem> itemRepo)
            {
